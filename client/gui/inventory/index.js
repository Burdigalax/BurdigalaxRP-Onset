        ...
        "inventories": [
            {
                ...
                "selectedNearbyInventoryId": key === "J" ? 26 : null,
                "nearbyInventoriesIds": key === "J" ? [
                    26,
                    27,
                    33
                ] : [33],
...
function setUpdateItemsInventories(idInventory, idItem, newQuantity){
    window.BURDIGALAX_inventory.updateItemsInventories(
        idInventory,
        [
            {
                id: idItem,
...
function setEquipItemInventory(idInventory, idItem, isEquipped){
    window.BURDIGALAX_inventory.updateItemsInventories(
        idInventory,
        [
            {
...
function ResetSelectedNearbyInventory(){
    window.BURDIGALAX_inventory.updateInventories([{
        id: 1,
