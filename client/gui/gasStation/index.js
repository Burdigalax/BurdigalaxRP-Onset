...
function SetErrorGasStation() {
    window.BURDIGALAX_gasStation.setPaymentError({
        title:"Erreur",
        message: "Système bancaire injoignable !"
    });
}

function UpdateGasStation(){
    window.BURDIGALAX_gasStation.updateStation({
        isOpen:true,
    })
}